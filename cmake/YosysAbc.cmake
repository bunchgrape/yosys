...
function(yosys_abc_target arg_LIBNAME arg_EXENAME)
	...
	set(all_sources)
	_yosys_abc_extract_makefile(module_files "MODULES :=" ${YOSYS_SOURCE_DIR}/abc/Makefile)
	_yosys_abc_extract_makefile(module_files_cudd "MODULES \\+=" ${YOSYS_SOURCE_DIR}/abc/Makefile)
	list(REMOVE_ITEM module_files "$(wildcard" "src/ext*)")
	foreach (module_file ${module_files} ${module_files_cudd})
		_yosys_abc_extract_makefile(module_sources "SRC \\+=" ${YOSYS_SOURCE_DIR}/abc/${module_file}/module.make)
	...
	target_link_libraries(${arg_LIBNAME} PUBLIC
		...
		$<$<BOOL:${WIN32}>:-lshlwapi>
		$<$<CXX_COMPILER_ID:MSVC>:${YOSYS_SOURCE_DIR}/abc/lib/x64/pthreadVC2.lib>
	)
	set_target_properties(${arg_LIBNAME} PROPERTIES
		YOSYS_IS_ABC ON
	)
	if(MSVC)
    	install(FILES "${YOSYS_SOURCE_DIR}/abc/lib/x64/pthreadVC2.dll" DESTINATION bin)
	endif()
