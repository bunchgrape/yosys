...
function(yosys_component arg_PREFIX arg_NAME)
	...
	if (share_file_pairs)
		set(data_depends)
		set(share_root ${YOSYS_BINARY_DIR}/share)
...
# Equivalent to copying `${YOSYS_BINARY_DIR}/share/.` to `<directory>/.` after a clean rebuild.
#
function(yosys_install_component_data)
	...
	foreach (component ${arg_COMPONENTS})
		...
		foreach (data_file ${data_files})
			...
			install(FILES ${YOSYS_BINARY_DIR}/share/${data_file} DESTINATION ${arg_DESTINATION}/${data_dir})
		endforeach()
	endforeach()
endfunction()
