...
function(yosys_cxx_library arg_TARGET arg_SCOPE)
	...
	set_target_properties(${arg_TARGET} PROPERTIES
		...
		RUNTIME_OUTPUT_DIRECTORY ${YOSYS_BINARY_DIR}
	)
	if (${arg_INSTALL_IF})
...
function(yosys_python_executable basename source)
	...
	if (CMAKE_SYSTEM_NAME STREQUAL MSYS)
		...
		add_executable(${basename} ${YOSYS_SOURCE_DIR}/misc/launcher.c)
		target_compile_definitions(${basename} GUI=0)
		set(scriptname ${YOSYS_BINARY_DIR}/${YOSYS_PROGRAM_PREFIX}${basename}-script.py)
		...
		set(scriptname ${YOSYS_BINARY_DIR}/${YOSYS_PROGRAM_PREFIX}${basename}${CMAKE_EXECUTABLE_SUFFIX})
