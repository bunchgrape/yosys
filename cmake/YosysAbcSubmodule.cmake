...
function(yosys_check_abc_submodule)
	...
	set(git_commit)
	if (EXISTS "${YOSYS_SOURCE_DIR}/abc/.gitcommit")
		file(READ "${YOSYS_SOURCE_DIR}/abc/.gitcommit" git_commit)
	...
	elseif (yosys_status STREQUAL "git") # OK
		...
		message(FATAL_ERROR
			"${YOSYS_SOURCE_DIR} is not configured as a git repository, and 'abc' folder is missing.\n"
