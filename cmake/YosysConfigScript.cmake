...
function(yosys_config_script scope)
	if (scope STREQUAL BUILD)
		set(BINDIR ${YOSYS_BINARY_DIR})
		set(LIBDIR ${YOSYS_BINARY_DIR})
		set(DATDIR ${YOSYS_BINARY_DIR}/share)
		set(suffix "")
	...
	configure_file(${YOSYS_SOURCE_DIR}/misc/yosys-config.in
		${YOSYS_PROGRAM_PREFIX}yosys-config${suffix}
		USE_SOURCE_PERMISSIONS
		@ONLY
	)
	if (scope STREQUAL INSTALL)
		install(PROGRAMS ${YOSYS_BINARY_DIR}/${YOSYS_PROGRAM_PREFIX}yosys-config.install
			RENAME yosys-config
