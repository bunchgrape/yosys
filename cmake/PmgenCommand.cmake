...
function(pmgen_command arg_NAME)
	...
	set(pmgen_script ${YOSYS_SOURCE_DIR}/passes/pmgen/pmgen.py)
	set(pmgen_output ${CMAKE_CURRENT_BINARY_DIR}/${arg_NAME}_pm.h)
	cmake_path(RELATIVE_PATH pmgen_output BASE_DIRECTORY ${YOSYS_BINARY_DIR} OUTPUT_VARIABLE pmgen_output_rel)
	add_custom_command(
